...
// create new uniform for light direction
...
void main(void){
    ...
    vec3 result = u_tint * u_lightcolor * (diffuse + ambient + specular); // for now this shader uses the tint color so you can see something
